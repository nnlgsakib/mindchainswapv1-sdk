...
describe('Pair', () => {
  const USDC = new Token(ChainId.MAINNET, '0xadBba1EF326A33FDB754f14e62A96D5278b942Bd', 18, 'USDC', 'USD Coin')
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0x592725B1df9D6208175a450c22d37a705F612689')
    })
  })
